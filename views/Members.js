        ...
        <div className="team-member">
            ...
            <div className="member-info">
                <a 
                    className="post-link" 
                    href={links[2]?.href || '#'} 
                    target={links[2]?.href ? '_blank' : undefined} 
                    rel={links[2]?.href ? 'noopener noreferrer' : undefined}
                    onClick={e => !links[2]?.href && e.preventDefault()}  // Prevent default action if href is empty
                >
                    {name}
                </a>
...
const Member = () => {
    ...
    const alumni = [
        ...
        },
        {
            ...
            name: 'Lê Hải Nam',
            position: 'Senior, FPT AI Residency'
        },
        {
            imgSrc: 'assets/img/members/avt.png',
            links: [
